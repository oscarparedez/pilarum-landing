...
import { IngresosChartsModal } from 'src/components/ingresos-charts-modal';
  ...
  return (
    <>
      <BusquedaFiltrada<IngresoGeneral>
        ...
        extraButtons={(ingresos, filters, sociosData, proyectosData) => (
          <Button
            variant="outlined"
            size="small"
      ...
      <IngresosChartsModal
        ...
        tipoIngresoFiltrado={
          currentFilters.tipo_ingreso
            ? tiposIngreso.find(t => t.id === currentFilters.tipo_ingreso)?.nombre
            : undefined
        }
